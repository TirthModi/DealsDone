...
import { verify_otp_seller } from '../../controller/seller-controller.js';
import Seller from '../../model/seller-schema.js';
import Otp from '../../model/otp-schema.js';

describe('verify_otp_seller API Function', function () {
  let req, res;
  ...
  it('should return a 400 error if email, otp, or password is missing', async () => {
    ...
    await verify_otp_seller(req, res);
  ...
  it('should successfully change the password if OTP is valid', async () => {
    ...
    sinon.stub(Seller, 'findOneAndUpdate').resolves(); // Mock user update
