...
import { forgot_password_seller} from '../../controller/seller-controller.js';
import Seller from '../../model/seller-schema.js';
import Otp from '../../model/otp-schema.js';

describe('forgot_password_seller Controller', () => {
    ...
    beforeEach(() => {
        ...
        findOneUserStub = sinon.stub(Seller, 'findOne');
    ...
    it('should return 400 if email is missing', async () => {
        ...
        await forgot_password_seller(mockRequest, mockResponse);
